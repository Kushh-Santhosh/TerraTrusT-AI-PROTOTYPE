...
async function run() {
  ...
  try {
    ...
    if (!n8nPage) {
      ...
      await n8nPage.goto("https://kushhhsanthosh.app.n8n.cloud/home/workflows", {
    ...
    await n8nPage
      .goto("https://kushhhsanthosh.app.n8n.cloud/home/executions", { waitUntil: "networkidle2" })
      .catch(() => {});
    ...
    const data = await n8nPage.evaluate(() => {
      const items = Array.from(
        document.querySelectorAll('tr, [data-test-id], [class*="execution"], [class*="card"]'),
      );
      return {
        bodySnippet: document.body.innerText.slice(0, 3000),
        hrefs: Array.from(document.querySelectorAll("a"))
          .map((a) => ({ text: a.innerText.trim(), href: a.href }))
          .filter((a) => a.href.includes("execution") || a.href.includes("workflow")),
      };
    });
