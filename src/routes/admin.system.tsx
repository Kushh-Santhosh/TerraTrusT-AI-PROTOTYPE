...
const services = [
  ...
  { name: "Postgres (primary)", status: "Healthy", uptime: "99.98%", latency: "1.2ms", icon: Database },
          ...
          <div key={s.name} className="surface-card p-5">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground">Uptime {s.uptime} · Latency {s.latency}</p>
              </div>
