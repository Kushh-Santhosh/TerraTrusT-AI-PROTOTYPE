            ...
            <div className="grid gap-6 p-6 sm:grid-cols-[1fr_auto]">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  12, 4th Cross, Ramamurthy Nagar · Bengaluru
                </p>
  ...
  const items = [
    {
      ...
      a: "Director, Karnataka Bhoomi Land Governance",
    },
    {
      q: "For the first time, our farmers can prove what they own without years in court. The Property Passport just works.",
      a: "Community Organizer, Mysuru District",
    },
    {
      ...
      a: "Head of Mortgages, State Bank of India",
    },
  ];
  return (
    <section className="mx-auto max-w-7xl px-6 py-24">
