        ...
        <div className="relative flex h-full flex-col justify-between p-12">
          ...
          <div>
            <h2 className="font-display max-w-md text-5xl text-foreground">
              A passport for every parcel of land.
            </h2>
            <p className="mt-3 max-w-md text-muted-foreground">
              Verify ownership, value, and boundaries — for governments, citizens, surveyors, and
              banks.
            </p>
          ...
          <p className="max-w-md text-xs text-muted-foreground">
            "We resolved 612 disputed parcels in our first quarter on TerraTrust." — Land Records
            Directorate, Karnataka
          </p>
        </div>
      </div>
    </div>
...
function Feat({ icon: Icon, t }: { icon: ComponentType<{ className?: string }>; t: string }) {
  return (
